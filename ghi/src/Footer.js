...
function Footer() {
    return (
    // <div className="grid grid-cols-3 w-full h-3/4 bg-gray-700">
    //     <div id="col-1">

    //     </div>

    //     <div id="col-2" className="flex flex-row justify-center">
    //         TEST
    //     </div>
    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div className="flex sm:flex items-center justify-center sm:items-center sm:justify-center">
        <div className="flex flex-col gap-3">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">Created by - <a href="https://github.com/zach-00" className="hover:underline">Zach Walkowiak</a>
          </span>
